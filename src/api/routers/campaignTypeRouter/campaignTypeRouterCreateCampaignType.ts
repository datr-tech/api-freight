...
import {
  ICampaignTypeControllerCreateCampaignTypeOutputError as IControllerError,
  ICampaignTypeControllerCreateCampaignTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					campaignTypeRouterCreateCampaignType
 *
 * @description		The 'createCampaignType' router for 'campaignType', whose expected
 *                inputs have been defined within the following schema:
 *                'campaignTypeValidationSchemaCreateCampaignType'.
 *
...
export const campaignTypeRouterCreateCampaignType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'campaignTypeValidationSchemaCreateCampaignType'.
      ...
      const stat = await campaignTypeController.createCampaignType(validatedParams);
