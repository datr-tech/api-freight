...
import {
  ITemplateControllerDeleteTemplateOutputError as IControllerError,
  ITemplateControllerDeleteTemplateOutputSuccess as IControllerSuccess,
...
/**
 * @name					templateRouterDeleteTemplate
 *
 * @description		The 'deleteTemplate' router for 'template', whose expected
 *                inputs have been defined within the following schema:
 *                'templateValidationSchemaDeleteTemplate'.
 *
 ...
 *                | Server error                | 500               |
 */
export const templateRouterDeleteTemplate = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'templateValidationSchemaDeleteTemplate'.
      ...
      const stat = await templateController.deleteTemplate(validatedParams);
       ...
       * 'templateId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ templateId: controllerResponsePayload['templateId'] });
    } catch (error) {
      /*
