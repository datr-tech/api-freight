...
import {
  ITemplateControllerCreateTemplateOutputError as IControllerError,
  ITemplateControllerCreateTemplateOutputSuccess as IControllerSuccess,
...
/**
 * @name					templateRouterCreateTemplate
 *
 * @description		The 'createTemplate' router for 'template', whose expected
 *                inputs have been defined within the following schema:
 *                'templateValidationSchemaCreateTemplate'.
 *
...
export const templateRouterCreateTemplate = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'templateValidationSchemaCreateTemplate'.
      ...
      const stat = await templateController.createTemplate(validatedParams);
