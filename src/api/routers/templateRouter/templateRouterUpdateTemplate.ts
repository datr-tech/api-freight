...
import {
  ITemplateControllerUpdateTemplateOutputError as IControllerError,
  ITemplateControllerUpdateTemplateOutputSuccess as IControllerSuccess,
...
/**
 * @name					templateRouterUpdateTemplate
 *
 * @description		The 'updateTemplate' router for 'template', whose expected
 *                inputs have been defined within the following schema:
 *                'templateValidationSchemaUpdateTemplate'.
 *
...
export const templateRouterUpdateTemplate = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'templateValidationSchemaUpdateTemplate'.
      ...
      const stat = await templateController.updateTemplate({ templateId, payload });
