...
import {
  ICampaignControllerUpdateCampaignOutputError as IControllerError,
  ICampaignControllerUpdateCampaignOutputSuccess as IControllerSuccess,
...
/**
 * @name					campaignRouterUpdateCampaign
 *
 * @description		The 'updateCampaign' router for 'campaign', whose expected
 *                inputs have been defined within the following schema:
 *                'campaignValidationSchemaUpdateCampaign'.
 *
...
export const campaignRouterUpdateCampaign = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'campaignValidationSchemaUpdateCampaign'.
      ...
      const stat = await campaignController.updateCampaign({ campaignId, payload });
