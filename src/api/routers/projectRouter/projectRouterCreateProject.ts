...
import {
  IProjectControllerCreateProjectOutputError as IControllerError,
  IProjectControllerCreateProjectOutputSuccess as IControllerSuccess,
...
/**
 * @name					projectRouterCreateProject
 *
 * @description		The 'createProject' router for 'project', whose expected
 *                inputs have been defined within the following schema:
 *                'projectValidationSchemaCreateProject'.
 *
...
export const projectRouterCreateProject = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'projectValidationSchemaCreateProject'.
      ...
      const stat = await projectController.createProject(validatedParams);
