...
import {
  IProjectControllerUpdateProjectOutputError as IControllerError,
  IProjectControllerUpdateProjectOutputSuccess as IControllerSuccess,
...
/**
 * @name					projectRouterUpdateProject
 *
 * @description		The 'updateProject' router for 'project', whose expected
 *                inputs have been defined within the following schema:
 *                'projectValidationSchemaUpdateProject'.
 *
...
export const projectRouterUpdateProject = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'projectValidationSchemaUpdateProject'.
      ...
      const stat = await projectController.updateProject({ projectId, payload });
