...
import {
  IProjectTypeControllerUpdateProjectTypeOutputError as IControllerError,
  IProjectTypeControllerUpdateProjectTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					projectTypeRouterUpdateProjectType
 *
 * @description		The 'updateProjectType' router for 'projectType', whose expected
 *                inputs have been defined within the following schema:
 *                'projectTypeValidationSchemaUpdateProjectType'.
 *
...
export const projectTypeRouterUpdateProjectType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'projectTypeValidationSchemaUpdateProjectType'.
      ...
      const stat = await projectTypeController.updateProjectType({
        projectTypeId,
        payload,
      });
