...
import {
  IProjectTypeControllerDeleteProjectTypeOutputError as IControllerError,
  IProjectTypeControllerDeleteProjectTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					projectTypeRouterDeleteProjectType
 *
 * @description		The 'deleteProjectType' router for 'projectType', whose expected
 *                inputs have been defined within the following schema:
 *                'projectTypeValidationSchemaDeleteProjectType'.
 *
 ...
 *                | Server error                | 500               |
 */
export const projectTypeRouterDeleteProjectType = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'projectTypeValidationSchemaDeleteProjectType'.
      ...
      const stat = await projectTypeController.deleteProjectType(validatedParams);
