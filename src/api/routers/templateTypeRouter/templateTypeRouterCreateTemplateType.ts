...
import {
  ITemplateTypeControllerCreateTemplateTypeOutputError as IControllerError,
  ITemplateTypeControllerCreateTemplateTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					templateTypeRouterCreateTemplateType
 *
 * @description		The 'createTemplateType' router for 'templateType', whose expected
 *                inputs have been defined within the following schema:
 *                'templateTypeValidationSchemaCreateTemplateType'.
 *
...
export const templateTypeRouterCreateTemplateType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'templateTypeValidationSchemaCreateTemplateType'.
      ...
      const stat = await templateTypeController.createTemplateType(validatedParams);
