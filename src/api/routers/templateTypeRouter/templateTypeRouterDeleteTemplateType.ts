...
import {
  ITemplateTypeControllerDeleteTemplateTypeOutputError as IControllerError,
  ITemplateTypeControllerDeleteTemplateTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					templateTypeRouterDeleteTemplateType
 *
 * @description		The 'deleteTemplateType' router for 'templateType', whose expected
 *                inputs have been defined within the following schema:
 *                'templateTypeValidationSchemaDeleteTemplateType'.
 *
 ...
 *                | Server error                | 500               |
 */
export const templateTypeRouterDeleteTemplateType = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'templateTypeValidationSchemaDeleteTemplateType'.
      ...
      const stat = await templateTypeController.deleteTemplateType(validatedParams);
       ...
       * 'templateTypeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ templateTypeId: controllerResponsePayload['templateTypeId'] });
    } catch (error) {
      /*
