...
import {
  ITemplateTypeControllerUpdateTemplateTypeOutputError as IControllerError,
  ITemplateTypeControllerUpdateTemplateTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					templateTypeRouterUpdateTemplateType
 *
 * @description		The 'updateTemplateType' router for 'templateType', whose expected
 *                inputs have been defined within the following schema:
 *                'templateTypeValidationSchemaUpdateTemplateType'.
 *
...
export const templateTypeRouterUpdateTemplateType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'templateTypeValidationSchemaUpdateTemplateType'.
      ...
      const stat = await templateTypeController.updateTemplateType({
        templateTypeId,
        payload,
      });
